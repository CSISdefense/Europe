...
EquNATO_EUspread <- subset(EuropeOmnibus, !is.na(EquSpendDelt_lead) & Country!="Turkey")
#Turkey's answers are only available for two years in the study period.

EquNATO_EUspread_gap1 <- subset(EquNATO_EUspread, !is.na(NATO.EUspread))
EquNATO_EUspread_gap2 <- subset(EquNATO_EUspread, !is.na(NATO.EUspread_lag1))
EquNATO_EUspread_gap3<- subset(EquNATO_EUspread, !is.na(NATO.EUspread_lag2))
...
NATO.EUspreadResults_model[1] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread, EquNATO_EUspread_gap1) )
...
NATO.EUspreadResults_model[2] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag1, EquNATO_EUspread_gap2))
...
NATO.EUspreadResults_model[3] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2, EquNATO_EUspread_gap3))
...
EquNATO_EUspread_gap3_pdata <- plm.data(EquNATO_EUspread_gap3, index=c("Country", "Year"))
...
reg<-4
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + IntAt, EquNATO_EUspread_gap3))
...
reg<-5
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + DomAt, EquNATO_EUspread_gap3))
...
reg<-6
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + CivilWar, EquNATO_EUspread_gap3))
NATO.EUspreadResults_name[reg]<-"CivilWar"
screenreg(NATO.EUspreadResults_model[c(1:3,reg)],
          custom.NATO.EUspreadResults_name=NATO.EUspreadResults_name[c(1:3,reg)])
summary(NATO.EUspreadResults_model[[reg]])
summary(EquNATO_EUspread_gap3$CivilWar)

#NATOessential removes Civil war cases 

reg<-7
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + IntlCnf, EquNATO_EUspread_gap3))
...
reg<-8
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt, EquNATO_EUspread_gap3))
NATO.EUspreadResults_name[reg]<-"GDPpCapLCUdelt"
screenreg(NATO.EUspreadResults_model[c(1:3,reg)],
          custom.NATO.EUspreadResults_name=NATO.EUspreadResults_name[c(1:3,reg)])
summary(NATO.EUspreadResults_model[[reg]])
...
reg<-9
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + Cab_left_right, EquNATO_EUspread_gap3))
...
reg<-10
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + Cab_liberty_authority, EquNATO_EUspread_gap3))
...
reg<-11
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + Cab_eu_anti_pro, EquNATO_EUspread_gap3))
...
reg<-12
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + left_right_ls_spread, EquNATO_EUspread_gap3))
...
reg<-13
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + liberty_authority_ls_spread, EquNATO_EUspread_gap3))
...
reg<-14
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, EquNATO_EUspread_gap3))
...
NATOEUSpreadResults_model14 <- lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, EquNATO_EUspread_gap3)


EquSpreadPooled <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, data = EquNATO_EUspread_gap3_pdata, model = "pooling")
screenreg(list(NATOEUSpreadResults_model14, EquSpreadPooled),
          custom.model.names = c("OLS", "Pooled"))

summary(EquSpreadPooled)

EquSpreadBetween <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, data = EquNATO_EUspread_gap3_pdata, model = "between")
...
EquSpreadWithin <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, data =  EquNATO_EUspread_gap3_pdata, model = "within")
...
# EquDefSpreadRandom <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, data = EquNATO_EUspread_gap3_pdata, model = "random")
