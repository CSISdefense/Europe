...
reg<-8
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt, EquNATO_EUspread_gap3))
...
reg<-9
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + Cab_left_right, EquNATO_EUspread_gap3))
...
reg<-10
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + Cab_liberty_authority, EquNATO_EUspread_gap3))
...
reg<-11
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + Cab_eu_anti_pro, EquNATO_EUspread_gap3))
...
reg<-12
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + left_right_ls_spread, EquNATO_EUspread_gap3))
...
reg<-13
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + liberty_authority_ls_spread, EquNATO_EUspread_gap3))
...
reg<-14
NATO.EUspreadResults_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + eu_anti_pro_ls_spread, EquNATO_EUspread_gap3))
...
NATOEUSpreadResults_model14 <- lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + eu_anti_pro_ls_spread, EquNATO_EUspread_gap3)


EquSpreadPooled <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data = EquNATO_EUspread_gap3_pdata, model = "pooling")
screenreg(list(NATOEUSpreadResults_model14, EquSpreadPooled),
          custom.model.names = c("OLS", "Pooled"))

summary(EquSpreadPooled)

EquSpreadBetween <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data = EquNATO_EUspread_gap3_pdata, model = "between")
...
EquSpreadWithin <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data =  EquNATO_EUspread_gap3_pdata, model = "within")
...
# EquDefSpreadRandom <- plm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data = EquNATO_EUspread_gap3_pdata, model = "random")
