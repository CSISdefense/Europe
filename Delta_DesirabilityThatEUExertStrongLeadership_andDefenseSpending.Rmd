...
EULeadershipSpread$intreu_anti_pro_ls_EUldrSread <- (EULeadershipSpread$EUldrSpreadC * EULeadershipSpread$eu_anti_pro_ls_spreadC)

EquEUDefSpreadResults14 <- lm(DefSpendDelt ~ EUldrSpreadC + IntlCnf + GDPpCapDelt + eu_anti_pro_ls_spreadC + intreu_anti_pro_ls_EUldrSread, EULeadershipSpread) 
...
DefSpreadPooled <- plm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapDelt + eu_anti_pro_ls_spread, data = EULeadershipSpread, model = "pooling")

DefSpreadWithin <- plm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapDelt + eu_anti_pro_ls_spread, data =  EULeadershipSpread, model = "within")
