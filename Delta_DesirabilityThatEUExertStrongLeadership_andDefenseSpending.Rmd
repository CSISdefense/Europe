...
EULeadershipResults0 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt, EULeadershipSpread_gap1) 
...
```{r Parliamentary}
EULeadershipResults7 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + Cab_left_right, EULeadershipSpread_gap1) 
...
EULeadershipResults8 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + Cab_liberty_authority, EULeadershipSpread_gap1) 
...
EULeadershipResults9 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + Cab_eu_anti_pro, EULeadershipSpread_gap1) 
...
EULeadershipResults10 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + left_right_ls_spread, EULeadershipSpread_gap1) 
...
EULeadershipResults11 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + liberty_authority_ls_spread, EULeadershipSpread_gap1) 
...
EULeadershipResults12 <- lm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spread, EULeadershipSpread_gap1) 
...
EquEUDefSpreadResults14 <- lm(DefSpendDelt ~ EUldrSpreadC + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spreadC + intreu_anti_pro_ls_EUldrSread, EULeadershipSpread_gap1) 
...
EULeadershipResultsDefSpread <- lm(DefSpendDelt ~ EUldrSpread + DefSpread_lag1 + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spread, subset(EULeadershipSpread_gap1, !is.na(DefSpread_lag1) ))
...
DefSpreadPooled <- plm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data = EULeadershipSpread_gap1_pdata, model = "pooling")

screenreg(list(EULeadershipResults12, DefSpreadPooled),
          custom.model.names = c("OLS", "Pooled"))
summary(DefSpreadPooled)

DefSpreadBetween <- plm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data = EULeadershipSpread_gap1_pdata, model = "between")
...
DefSpreadWithin <- plm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data =  EULeadershipSpread_gap1_pdata, model = "within")
...
DefSpreadRandom <- plm(DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapUSDdelt + eu_anti_pro_ls_spread, data = EULeadershipSpread_gap1_pdata, model = "random")
