...
OnMEULeadershipResults1 <- lm(OnMspendDelt ~ EUldrSpread, EULeadershipSpread_gap1) 
summary(OnMEULeadershipResults1)
screenreg(list(OnMEULeadershipResults1))

OnMEULeadershipResults2 <- lm(OnMspendDelt ~ EUldrSpread_lag1, EULeadershipSpread_gap2) 
...
OnMEULeadershipResults3 <- lm(OnMspendDelt ~ EUldrSpread_lag2, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults4 <- lm(OnMspendDelt ~ EUldrSpread_lag2 + IntAt, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults5 <- lm(OnMspendDelt ~ EUldrSpread_lag2 + CivilWar, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults6 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + IntlCnf, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults7 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + GDPpCapUSDdelt, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults8 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + Cab_left_right, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults9 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + Cab_liberty_authority, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults2 <- lm(OnMspendDelt ~ EUldrSpread_lag2  +  Cab_eu_anti_pro, EULeadershipSpread_gap3) 
summary(OnMEULeadershipResults2)
...
OnMEULeadershipResults11 <- lm(OnMspendDelt ~ EUldrSpread_lag2   + left_right_ls_spread, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults12 <- lm(OnMspendDelt ~ EUldrSpread_lag2   + liberty_authority_ls_spread, EULeadershipSpread_gap3) 
...
OnMEULeadershipResults13 <- lm(OnMspendDelt ~ EUldrSpread_lag2   + eu_anti_pro_ls_spread, EULeadershipSpread_gap3) 
...
EULeadershipResults2 <- lm(OnMspendDelt ~ EUldrSpread_lag2  , EULeadershipSpread_gap3) 
summary(OnMEULeadershipResults2)
screenreg(list(OnMEULeadershipResults2, OnMEULeadershipResults5, OnMEULeadershipResults9, OnMEULeadershipResults2),
              custom.model.names=c("PubOp_1","CivilWar", "cablibertyauthority", "cabeuantipro"))


OnMspreadPooled <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = EULeadershipSpread_gap2_pdata, model = "pooling")
...
OnMspreadBetween <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = EULeadershipSpread_gap2_pdata, model = "between")
...
OnMspreadWithin <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data =  EULeadershipSpread_gap2_pdata, model = "within")
...
# OnMspreadRandom <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = EULeadershipSpread_gap2_pdata, model = "random")
