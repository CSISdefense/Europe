...
pdata <- plm.data(EULeadershipSpread_lag1, index=c("Country", "Year"))
...
OnMEULeadershipResults1 <- lm(OnMspendDelt ~ EUldrSpread, EULeadershipSpread_lag0) 
summary(OnMEULeadershipResults1)
screenreg(list(OnMEULeadershipResults1))

OnMEULeadershipResults2 <- lm(OnMspendDelt ~ EUldrSpread_lag1, EULeadershipSpread_lag1) 
...
OnMEULeadershipResults3 <- lm(OnMspendDelt ~ EUldrSpread_lag2, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults4 <- lm(OnMspendDelt ~ EUldrSpread_lag2 + IntAt, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults5 <- lm(OnMspendDelt ~ EUldrSpread_lag2 + CivilWar, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults6 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + IntlCnf, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults7 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + GDPpCapDelt, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults8 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + Cab_left_right, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults9 <- lm(OnMspendDelt ~ EUldrSpread_lag2  + Cab_liberty_authority, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults2 <- lm(OnMspendDelt ~ EUldrSpread_lag2  +  Cab_eu_anti_pro, EULeadershipSpread_lag2) 
summary(OnMEULeadershipResults2)
...
OnMEULeadershipResults11 <- lm(OnMspendDelt ~ EUldrSpread_lag2   + left_right_ls_spread, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults12 <- lm(OnMspendDelt ~ EUldrSpread_lag2   + liberty_authority_ls_spread, EULeadershipSpread_lag2) 
...
OnMEULeadershipResults13 <- lm(OnMspendDelt ~ EUldrSpread_lag2   + eu_anti_pro_ls_spread, EULeadershipSpread_lag2) 
...
EULeadershipResults2 <- lm(OnMspendDelt ~ EUldrSpread_lag2  , EULeadershipSpread_lag2) 
summary(OnMEULeadershipResults2)
screenreg(list(OnMEULeadershipResults2, OnMEULeadershipResults5, OnMEULeadershipResults9, OnMEULeadershipResults2),
              custom.model.names=c("PubOp_1","CivilWar", "cablibertyauthority", "cabeuantipro"))


OnMspreadPooled <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = pdata, model = "pooling")
...
OnMspreadBetween <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = pdata, model = "between")
...
OnMspreadFD <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = pdata, model = "fd") ##when variables don't vary from one year to the next, the variable is dropped because the first difference takes difference of the model averaged over time from the original model and for these variables the value would be 0.
...
OnMspreadWithin <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data =  pdata, model = "within")
...
# OnMspreadRandom <- plm(OnMspendDelt ~ EUldrSpread_lag2  , data = pdata, model = "random")
