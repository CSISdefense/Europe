...
htmlreg(list(EuropeModel$fixed[[1]],EuropeModel$random[[2]]),
        file="Output\\Hypothesis1.html",
        custom.model.name=c(as.character(EuropeModel$name[1:2])),
        digits=3,
...
htmlreg(list(EuropeModel$fixed[[3]],EuropeModel$fixed[[4]]),
...
#Model # 12is Defense O&M/Other and EU closer to US
EuropeModel<-rbind(
    EuropeModel[1:11,],
...
htmlreg(list(EuropeModel$fixed[[5]],EuropeModel$fixed[[6]],EuropeModel$fixed[[7]],EuropeModel$fixed[[8]]),
...
screenreg(list(EuropeModel$random[[2]],EuropeModel$fixed[[4]],EuropeModel$fixed[[7]],EuropeModel$fixed[[8]]),
