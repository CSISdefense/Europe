...
``` {r Hyp2a_EU_Leadership, echo = TRUE}
...
screenreg(list(Europe_model$fd[[5]],Europe_model$fd[[6]],Europe_model$fd[[7]],Europe_model$fd[[8]]),
          ...
          digits=4,
          stars=c(0.01,0.05,0.1),
          reorder.coef=c(1,8,2,3,6,4,5,7),
          groups = list("Intercept" = 1,"Polling" = 2:5, "Macroeconomic" = 6, "Parliamentary"=7:8)
...
```{r DefenseDependent}
screenreg(list(Europe_model$pooling[[1]],Europe_model$pooling[[3]],Europe_model$fd[[5]],Europe_model$fd[[7]]),
          custom.model.name=c(as.character(Europe_model$name[c(1,3,5,7)])),
          digits=4,
          stars=c(0.01,0.05,0.1),
          reorder.coef=c(1,7,2,4,8,9,5,3,6),
          groups = list("Intercept" = 1:2,"Polling" = 3:6, "Security"=7,"Macroeconomic" = 8, "Parliamentary"=9)
          )
...
screenreg(list(Europe_model$pooling[[2]],Europe_model$pooling[[4]],Europe_model$fd[[6]],Europe_model$fd[[8]]),
          custom.model.name=c(as.character(Europe_model$name[c(2,4,6,8)])),
          digits=4,
          stars=c(0.01,0.05,0.1),
