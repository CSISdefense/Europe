...
Europe_model<-rbind(
    ...
    panelmodels(selected.formula="DefSpendDelt ~ EUldrSpread + IntlCnf + GDPpCapDelt +
                ...
                dependent.name="Const. Defense Spending % Change "
                include.random=TRUE)
)
...
screenreg(list(Europe_model$pooling[[3]],Europe_model$pooling[[4]]),
          ...
          custom.coef.names = c(NA,
                                "European Leadership Spread (t-1)",
                                "International Conflict (t-1)",
                                "Const. GDP Per Cap. % Change (t-1)",
                                "EU-Anti-Pro Spread^2 (t-1)",
                                "European Leadership Spread (t-2)",
                                "Civil War (t-21 to t-1)",
                                "Cabinet Liberty-Authority (t-1)",
                                "Cabinet EU-Anti-Pro (t-1)"),
