...
Europe_model<-rbind(
    Europe_model[1:4,],
    panelmodels(selected.formula="DefSpendDelt_lead ~ NATO.EUspread_lag1   + liberty_authority_ls_spread",
                source.data=DefSpread,
...
#Model #7 is Equipment Spending and NATO EU convergence
...
screenreg(list(Europe_model$fd[[5]],Europe_model$fd[[6]],Europe_model$fd[[7]],Europe_model$fd[[8]]),
          ...
          digits=4,
          stars=c(0.01,0.05,0.1),
          reorder.coef=c(1,2,6,5,8,3,4,7),
...
screenreg(list(Europe_model$pooling[[1]],Europe_model$pooling[[3]],Europe_model$fd[[5]],Europe_model$fd[[6]]),
          ...
          digits=4,
          stars=c(0.01,0.05,0.1),
          reorder.coef=c(1,7,2,4,8,10,5,3,6,9),
          groups = list("Intercept" = 1:2,"Polling" = 3:6, "Security"=7,"Macroeconomic" = 8, "Parliamentary"=9:10)
          )
