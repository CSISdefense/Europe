...
reg<-8
NATOessOnMspread_model[reg] <- list(lm(OnMspendDelt_lead ~ NATOessSpread_lag1  +GDPpCapUSDdelt, EquNATOessSpread_gap2))
NATOessOnMspread_name[reg]<-"GDPpCapUSDdelt"
...
Tepted to add GDPpCapUSDdelt which had a sign that made sense and improved p value of the lag, but reduces the adjusted R^2.
