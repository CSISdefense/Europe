...
EUDefSpreadResultsA <- plm(DefSpendDelt_lead ~ DefSpread +  IntAt + PopulationDelt + GDPpCapDelt + Cab_eu_anti_pro, data = EuropeDefSpread, index=c("Country", "Year"), model="within") 
