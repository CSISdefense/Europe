...
DefLine<-DefLine+geom_line(color="black")+
    scale_color_discrete(guide=F)+
    theme_bw()+
...
DefLine+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
...
DefLineLog+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
    theme(strip.text.y=element_text(angle=0))
...
#Unmodified across one row per country
EquLine+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
    theme(strip.text.y=element_text(angle=0))
...
#Logs across one row per country
EquLineLog+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
    theme(strip.text.y=element_text(angle=0))




OnMline<-LatticeLineWrapper(VAR.color.legend.label="",
                             VAR.main.label="",
                             VAR.X.label="Year",
...
#Unmodified across one row per country
OnMline+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
    theme(strip.text.y=element_text(angle=0))
...
#Logs across one row per country
OnMlineLog+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
    theme(strip.text.y=element_text(angle=0))
...
GDPlineDelt<-LatticeLineWrapper(VAR.color.legend.label="",
                             VAR.main.label="",
                             VAR.X.label="Year",
...
GDPline<-LatticeLineWrapper(VAR.color.legend.label="",
                             VAR.main.label="",
                             VAR.X.label="Year",
                             VAR.Y.label="GDP in 2014 Euros",
                             VAR.Coloration=Coloration,
                             VAR.long.DF=EuropeSample,
                             # ,VAR.ncol=NA
                             VAR.x.variable="Year",
                             VAR.y.variable="NGDP_eu2014",
                             VAR.y.series="Country",
                             VAR.facet.primary="Country",
                             # VAR.facet.secondary=NA
                             # MovingAverage=1
...
# 
GDPline<-GDPline+geom_line(color="black")+
    scale_color_discrete(guide=F)+
    theme_bw()+
...
#Unmodified across one row per country
GDPline+facet_grid(primary~.,scales="free_y")+theme(axis.text.y = element_text(angle = 0, hjust = 1))+
    theme(strip.text.y=element_text(angle=0))
...
DeficitLine<-LatticeLineWrapper(VAR.color.legend.label="",
                             VAR.main.label="",
                             VAR.X.label="Year",
                             VAR.Y.label="Deficit as Percent of GDP",
                             VAR.Coloration=Coloration,
                             VAR.long.DF=EuropeSample,
                             # ,VAR.ncol=NA
                             VAR.x.variable="Year",
                             VAR.y.variable="Dfc_NGDP",
                             VAR.y.series="Country",
                             VAR.facet.primary="Country",
                             # VAR.facet.secondary=NA
                             # MovingAverage=1
