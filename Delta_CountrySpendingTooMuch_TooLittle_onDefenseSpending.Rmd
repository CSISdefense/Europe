...
screenreg(list(lm(DefSpendDelt_lead ~ DefSpread, EuropeDefSpread_gap1),
               lm(DefSpendDelt_lead ~ DefSpread_lag1, EuropeDefSpread_gap2),
               lm(DefSpendDelt_lead ~ DefSpread_lag2, EuropeDefSpread_gap3)),
          custom.model.names=c("PubOp_1","PubOp_2","PubOp_3"))

screenreg(list(lm(EquSpendDelt_lead ~ DefSpread, EuropeDefSpread_gap1),
               lm(EquSpendDelt_lead ~ DefSpread_lag1, EuropeDefSpread_gap2),
               lm(EquSpendDelt_lead ~ DefSpread_lag2, EuropeDefSpread_gap3)),
          custom.model.names=c("PubOp_1","PubOp_2","PubOp_3"))
...
screenreg(list(lm(DefSpendDelt_lead ~ DefSpread_lag1, EuropeDefSpread_gap2),
               lm(EquSpendDelt_lead ~ DefSpread_lag1, EuropeDefSpread_gap2),
               lm(OnMspendDelt_lead ~ DefSpread_lag1, EuropeDefSpread_gap2)),
          custom.model.names=c("PubOp_Def","PubOp_Equ","PubOp_OnM"))
               


screenreg(list(lm(DefSpendDelt_lead ~ DefSpread_lag1+GDPpCapLCUdelt, EuropeDefSpread_gap2),
               lm(EquSpendDelt_lead ~ DefSpread_lag2+GDPpCapLCUdelt, EuropeDefSpread_gap3),
               lm(OnMspendDelt_lead ~ DefSpread_lag1+GDPpCapLCUdelt, EuropeDefSpread_gap2)),
          custom.model.names=c("PubOp_Def","PubOp_Equ","PubOp_OnM"))
...
EUDefSpreadResults2 <- lm(DefSpendDelt_lead ~ DefSpread_lag, EuropeDefSpread_gap2) 
summary(EUDefSpreadResults2)

EUEquSpreadResults2 <- lm(EquSpendDelt_lead ~ DefSpread_lag2, EuropeDefSpread_gap3) 
summary(EUEquSpreadResults2)
...
EUDefSpreadResults9 <- lm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt + Cab_left_right, EuropeDefSpread_gap2)
...
EUDefSpreadResults10 <- lm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt + Cab_liberty_authority, EuropeDefSpread_gap2)
...
EUDefSpreadResults11 <- lm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt + Cab_eu_anti_pro, EuropeDefSpread_gap2)
...
EUDefSpreadResults12 <- lm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt + left_right_ls_spread, EuropeDefSpread_gap2)
...
EUDefSpreadResults13 <- lm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt + liberty_authority_ls_spread, EuropeDefSpread_gap2)
...
EUDefSpreadResults14 <- lm(DefSpendDelt_lead ~ DefSpread_lag1  + GDPpCapLCUdelt + eu_anti_pro_ls_spread, EuropeDefSpread_gap2)
...
DefSpreadPooled <- plm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt, data = EuropeDefSpread_gap2_pdata, model = "pooling")
summary(DefSpreadPooled)
screenreg(list(EUDefSpreadResults8, DefSpreadPooled),
          custom.model.names = c("OLS", "Pooled"))

DefSpreadBetween <- plm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt, data = EuropeDefSpread_gap2_pdata, model = "between")
...
DefSpreadWithin <- plm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt, data =  EuropeDefSpread_gap2_pdata, model = "within")
...
# DefSpreadRandom <- plm(DefSpendDelt_lead ~ DefSpread_lag1 + GDPpCapLCUdelt, data = EuropeDefSpread_gap2_pdata, model = "random")
