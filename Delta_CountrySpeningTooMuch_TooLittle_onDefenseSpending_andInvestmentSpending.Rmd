...
EUequSpreadResultsA <- plm(EquSpendDelt ~ DefSpread_lag2 + left_right_ls_spread, data = EuropeDefSpread_lag2, index=c("Country", "Year"), model="within") 
summary(EUequSpreadResultsA)

screenreg(list(EquEUDefSpreadResults11, EUequSpreadResultsA))

#testing for fixed effects
pFtest(EUequSpreadResultsA, EquEUDefSpreadResults11)
