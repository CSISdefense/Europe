...
reg<-9
NATOessSpreadEqu_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapDelt + Cab_left_right, EquNATOessSpread_lag2))
...
reg<-10
NATOessSpreadEqu_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapDelt + Cab_liberty_authority, EquNATOessSpread_lag2))
...
reg<-11
NATOessSpreadEqu_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapDelt + Cab_eu_anti_pro, EquNATOessSpread_lag2))
...
reg<-12
NATOessSpreadEqu_model[reg] <- list(lm(EquSpendDelt_lead ~ NATO.EUspread_lag2  + GDPpCapDelt + left_right_ls_spread, EquNATOessSpread_lag2))
...
screenreg(NATOessSpreadEqu_model[c(1:3,12,reg)],
          custom.NATOessSpreadEqu_name=NATOessSpreadEqu_name[c(1:3,reg)])
summary(NATOessSpreadEqu_model[[reg]])
...
screenreg(NATOessSpreadEqu_model[c(1:3,12,13,reg)],
          custom.NATOessSpreadEqu_name=NATOessSpreadEqu_name[c(1:3,12,13,reg)])
summary(NATOessSpreadEqu_model[[reg]])
plot(NATOessSpreadEqu_model[[reg]])
