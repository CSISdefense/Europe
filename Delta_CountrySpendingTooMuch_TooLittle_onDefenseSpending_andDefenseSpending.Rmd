...
EuropeDefSpread_lag2_lag0 <- subset(EuropeDefSpread_lag2, !is.na(DefSpread))
EuropeDefSpread_lag2_lag1 <- subset(EuropeDefSpread_lag2, !is.na(DefSpread_lag1))
EuropeDefSpread_lag2_lag2 <- subset(EuropeDefSpread_lag2, !is.na(DefSpread_lag2))
...
##load data using function
EuropeDefSpread_lag2 <- subset(EuropeOmnibus, !is.na(DefSpendDelt_lead))

EuropeDefSpread_lag2 <- subset(EuropeDefSpread_lag2, !is.na(DefSpread))

##get rid of sweden
EuropeDefSpread_lag2 <- subset(EuropeDefSpread_lag2, !Country %in% c("Sweden", "Serbia", "Bulgaria", "Romania"))

EuropeDefSpread_lag2 <- subset(EuropeDefSpread_lag2, !Year %in% c("2002"))
...
EUDefSpreadResultsA <- plm(DefSpendDelt_lead ~ DefSpread_lag2 + IntAt + CivilWar + GDPpCapDelt, data = EuropeDefSpread_lag2, index=c("Country", "Year"), model="within") 
summary(EUDefSpreadResultsA)

screenreg(list(EUDefSpreadResults8, EUDefSpreadResultsA))
...
EUDefSpreadResultsWithin <- plm(DefSpendDelt_lead ~ DefSpread_lag2 + IntAt + CivilWar + GDPpCapDelt, data = EuropeDefSpread_lag2, index=c("Country", "Year"), model="within") 

EUDefSpreadResultsRandom <- plm(DefSpendDelt_lead ~ DefSpread_lag2 + IntAt + CivilWar + GDPpCapDelt, data = EuropeDefSpread_lag2, index=c("Country", "Year"), model="random")
