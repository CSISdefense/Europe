...
```{r Macroeconomics}
EquEUDefSpreadResults7 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt, EuropeDefSpread_gap3) 
...
```{r Cabinet}
EquEUDefSpreadResults8 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + Cab_left_right, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults9 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + Cab_liberty_authority, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults10 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + Cab_eu_anti_pro, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults11 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults12 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread + liberty_authority_ls_spread, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults13 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread + eu_anti_pro_ls_spread, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults14 <- lm(EquSpendDelt ~ DefSpread_lag2C + GDPpCapLCUdelt + left_right_ls_spreadC + intrleft_right_ls_DefSread, EuropeDefSpread_gap3) 
...
EquSpreadPooled <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread, data = EuropeDefSpread_gap3_pdata, model = "pooling")

screenreg(list(EquEUDefSpreadResults11, EquSpreadPooled),
          custom.model.names = c("OLS", "Pooled"))

EquSpreadBetween <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread, data = EuropeDefSpread_gap3_pdata, model = "between")
...
EquSpreadWithin <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread, data =  EuropeDefSpread_gap3_pdata, model = "within")
...
EquSpreadRandom <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapLCUdelt + left_right_ls_spread, data = EuropeDefSpread_gap3_pdata, model = "random")
