...
EquEUDefSpreadResults1 <- lm(EquSpendDelt ~ DefSpread, EuropeDefSpread_gap1) 
summary(EquEUDefSpreadResults1)

EquEUDefSpreadResults2 <- lm(EquSpendDelt ~ DefSpread_lag1, EuropeDefSpread_gap2) 
...
EquEUDefSpreadResults3 <- lm(EquSpendDelt ~ DefSpread_lag2, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults4 <- lm(EquSpendDelt ~ DefSpread_lag2 + IntAt, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults5 <- lm(EquSpendDelt ~ DefSpread_lag2 + CivilWar, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults6 <- lm(EquSpendDelt ~ DefSpread_lag2 + IntlCnf, EuropeDefSpread_gap3) 
...
```{r Macroeconomics}
EquEUDefSpreadResults7 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt, EuropeDefSpread_gap3) 
...
```{r Cabinet}
EquEUDefSpreadResults8 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + Cab_left_right, EuropeDefSpread_gap3) 
...
screenreg(list(EquEUDefSpreadResults1,EquEUDefSpreadResults2, EquEUDefSpreadResults3, EquEUDefSpreadResults7, EquEUDefSpreadResults8),
          custom.model.names=c("PubOp_df1","PubOp_df2", "PubOp_df3", "GDPpCapUSDdelt", "Cableftright"))

##cableft right not significant will not include

EquEUDefSpreadResults9 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + Cab_liberty_authority, EuropeDefSpread_gap3) 
...
screenreg(list(EquEUDefSpreadResults1,EquEUDefSpreadResults2, EquEUDefSpreadResults3, EquEUDefSpreadResults7, EquEUDefSpreadResults9),
          custom.model.names=c("PubOp_df1","PubOp_df2", "PubOp_df3","GDPpCapUSDdelt", "lib_authority"))

##cab liberty authority not significant won't be included

EquEUDefSpreadResults10 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + Cab_eu_anti_pro, EuropeDefSpread_gap3) 
...
screenreg(list(EquEUDefSpreadResults1,EquEUDefSpreadResults2, EquEUDefSpreadResults3, EquEUDefSpreadResults7, EquEUDefSpreadResults10),
          custom.model.names=c("PubOp_df1","PubOp_df2", "PubOp_df3", "GDPpCapUSDdelt", "euAntiPro"))

##not significant, won't be included eu anti pro

EquEUDefSpreadResults11 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults12 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread + liberty_authority_ls_spread, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults13 <- lm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread + eu_anti_pro_ls_spread, EuropeDefSpread_gap3) 
...
EquEUDefSpreadResults14 <- lm(EquSpendDelt ~ DefSpread_lag2C + GDPpCapUSDdelt + left_right_ls_spreadC + intrleft_right_ls_DefSread, EuropeDefSpread_gap3) 
...
EquSpreadPooled <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread, data = EuropeDefSpread_gap3_pdata, model = "pooling")

screenreg(list(EquEUDefSpreadResults11, EquSpreadPooled),
          custom.model.names = c("OLS", "Pooled"))

EquSpreadBetween <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread, data = EuropeDefSpread_gap3_pdata, model = "between")
...
EquSpreadWithin <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread, data =  EuropeDefSpread_gap3_pdata, model = "within")
...
EquSpreadRandom <- plm(EquSpendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + left_right_ls_spread, data = EuropeDefSpread_gap3_pdata, model = "random")
