...
OnMEUDefSpreadResults7 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt, EuropeDefSpread_gap3) 
...
```{r Cabinet}
OnMEUDefSpreadResults8 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + Cab_left_right, EuropeDefSpread_gap3) 
...
OnMEUDefSpreadResults9 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + Cab_liberty_authority, EuropeDefSpread_gap3) 
...
OnMEUDefSpreadResults10 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt + Cab_eu_anti_pro, EuropeDefSpread_gap3) 
...
OnMEUDefSpreadResults11 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt +left_right_ls_spread , EuropeDefSpread_gap3) 
...
OnMEUDefSpreadResults12 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt  + liberty_authority_ls_spread, EuropeDefSpread_gap3) 
...
OnMEUDefSpreadResults13 <- lm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt  + eu_anti_pro_ls_spread, EuropeDefSpread_gap3) 
...
OnMspreadPooled <- plm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt , data = EuropeDefSpread_gap3_pdata, model = "pooling")

screenreg(list(OnMEUDefSpreadResults7, OnMspreadPooled),
          custom.model.names = c("OLS", "Pooled"))

OnMspreadBetween <- plm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt , data = EuropeDefSpread_gap3_pdata, model = "between")
...
OnMspreadWithin <- plm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt , data =  EuropeDefSpread_gap3_pdata, model = "within")
...
OnMspreadRandom <- plm(OnMspendDelt ~ DefSpread_lag2 + GDPpCapUSDdelt , data = EuropeDefSpread_gap3_pdata, model = "random")
