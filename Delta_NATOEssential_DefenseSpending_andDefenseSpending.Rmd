...
EUDefSpreadResults_EUspread <- lm(DefSpendDelt_lead ~ NATOessSpread_lag2 +  IntlCnf + GDPpCapDelt + Cab_liberty_authority+ eu_anti_pro_ls_spread + eu_anti_pro_ls_spread:NATOessSpread_lag2 , EuropeNATOessSpread_lag2)
