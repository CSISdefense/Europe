...
reg<-7
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+IntlCnf, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+IntlCnf, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+IntlCnf, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+IntlCnf, EuropeOmnibus))
nModel[reg]<-"IntlCnf"
reg<-8
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil, EuropeOmnibus))
nModel[reg]<-"UNmil"
...
screenreg(c(lmMoreDef[c(6:8)],
               ...
               lmNATOess[c(6:8)],
               lmEU_UScls[c(6:8)]),
               custom.model.names=c(rep(nModel[c(6:8)],4)))
...
reg<-9
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil+DomAt, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil +DomAt,
                      EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil +DomAt,
                        EuropeNATOess))
...
reg<-10
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil+IntAt, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil+IntAt, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil+IntAt, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXCNL_NGDP+UNmilitaryPMil+IntAt,
                         EuropeOmnibus))
nModel[reg]<-"IntAt"
