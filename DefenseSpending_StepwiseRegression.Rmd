...
DebtScatter <- melt(EuropeOmnibus, measure.vars = c("GGXWDG_NGDP",
                                           "EUdebtPGDP"))
...
reg<-5
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP, EuropeEUcloserUS))
nModel[reg]<-"GGXWDG"

reg<-6
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP, EuropeEUcloserUS))
nModel[reg]<-"+EUdebtPGDP"
...
reg<-7
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGSB_NPGDP, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGSB_NPGDP, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGSB_NPGDP, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGSB_NPGDP, EuropeEUcloserUS))
nModel[reg]<-"GGSB"
reg<-8
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP, EuropeEUcloserUS))
nModel[reg]<-"GGXCNL"
...
reg<-9
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+
                            GGXCNL_NGDP+IntlCnf, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                          log(Population)+GGXWDG_NGDP+EUdebtPGDP+  
                          GGXCNL_NGDP+IntlCnf, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+  
                            GGXCNL_NGDP+IntlCnf, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                             log(Population)+GGXWDG_NGDP+EUdebtPGDP+   
                             GGXCNL_NGDP+IntlCnf, EuropeEUcloserUS))
nModel[reg]<-"IntlCnf"
reg<-10
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + 
                            log(NGDPPC_eu2014)+log(Population)+GGXWDG_NGDP+
                            EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil,
                        EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + 
                          log(NGDPPC_eu2014)+log(Population)+
                          GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil,
                      EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil,
                        EuropeNATOess))
...
reg<-11
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil+DomAt, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil +DomAt,
                      EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil +DomAt,
                        EuropeNATOess))
...
reg<-12
lmMoreDef[reg]<-list(lm(log(DefSpend_lead) ~ DefSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil+IntAt, EuropeMoreDef))
lmEUldr[reg]<-list(lm(log(DefSpend_lead) ~ EUldrSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil+IntAt, EuropeEUleadership))
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil+IntAt, EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+UNmilitaryPMil+IntAt,
                         EuropeEUcloserUS))
nModel[reg]<-"IntAt"
...
lmNATOess[reg]<-list(lm(log(DefSpend_lead) ~ NATOessSpread_lag1 + log(NGDPPC_eu2014)+
                        ...
                        EuropeNATOess))
lmEU_UScls[reg]<-list(lm(log(DefSpend_lead) ~ EUcloserUSspread_lag1+ log(NGDPPC_eu2014)+
                             log(Population)+GGXWDG_NGDP+EUdebtPGDP+GGXCNL_NGDP+
...
EuropeModel<-panelmodels(selected.formula=paste("log(DefSpend_lead) ~ DefSpread_lag1",SelectedControlsWithTimeProxy),
...
SelectedControlsWithTimeProxy<-"+ log(NGDPPC_eu2014)+
                            log(Population)+GGXWDG_NGDP+GGXCNL_NGDP+
