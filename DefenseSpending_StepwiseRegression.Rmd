...
Pro/Anti EU attitudes do reach significance in three cases and appear to be more significant when the cabinet polorization on the issue is not include. Thus we choose to add only the EU anti/pro cabinet classification.
