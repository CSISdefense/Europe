...
EquiEULeadershipResults5 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults6 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + IntlCnf, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults7 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + GDPpCapLCUdelt, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults8 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_left_right, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults9 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults10 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults11 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro + left_right_ls_spread, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults12 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro + liberty_authority_ls_spread, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults13 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro + eu_anti_pro_ls_spread, EULeadershipSpread_gap2) 
...
EULeadershipResults10 <- lm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, EULeadershipSpread_gap2) 
summary(EquiEULeadershipResults10)
screenreg(list(EquiEULeadershipResults2, EquiEULeadershipResults5, EquiEULeadershipResults9, EquiEULeadershipResults10),
              custom.model.names=c("PubOp_1","CivilWar", "cablibertyauthority", "cabeuantipro"))


EquSpreadPooled <- plm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data = EULeadershipSpread_gap2_pdata, model = "pooling")
...
EquSpreadBetween <- plm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data = EULeadershipSpread_gap2_pdata, model = "between")
...
EquSpreadWithin <- plm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data =  EULeadershipSpread_gap2_pdata, model = "within")
...
# EquSpreadRandom <- plm(EquSpendDelt_lead ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data = EULeadershipSpread_gap2_pdata, model = "random")
