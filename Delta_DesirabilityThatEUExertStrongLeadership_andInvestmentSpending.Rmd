...
EquiEULeadershipResults1 <- lm(EquSpendDelt ~ EUldrSpread, EULeadershipSpread_gap1) 
summary(EquiEULeadershipResults1)
screenreg(list(EquiEULeadershipResults1))

EquiEULeadershipResults2 <- lm(EquSpendDelt ~ EUldrSpread_lag1, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults3 <- lm(EquSpendDelt ~ EUldrSpread_lag2, EULeadershipSpread_gap3) 
...
EquiEULeadershipResults4 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + IntAt, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults5 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults6 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + IntlCnf, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults7 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + GDPpCapUSDdelt, EULeadershipSpread_gap2) 
...
##GDPpCapUSDdelt isnt significant and will not  be included.
```
...
EquiEULeadershipResults8 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_left_right, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults9 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults10 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults11 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro + left_right_ls_spread, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults12 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro + liberty_authority_ls_spread, EULeadershipSpread_gap2) 
...
EquiEULeadershipResults13 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro + eu_anti_pro_ls_spread, EULeadershipSpread_gap2) 
...
EULeadershipResults10 <- lm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, EULeadershipSpread_gap2) 
summary(EquiEULeadershipResults10)
screenreg(list(EquiEULeadershipResults2, EquiEULeadershipResults5, EquiEULeadershipResults9, EquiEULeadershipResults10),
              custom.model.names=c("PubOp_1","CivilWar", "cablibertyauthority", "cabeuantipro"))


EquSpreadPooled <- plm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data = EULeadershipSpread_gap2_pdata, model = "pooling")
...
EquSpreadBetween <- plm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data = EULeadershipSpread_gap2_pdata, model = "between")
...
EquSpreadWithin <- plm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data =  EULeadershipSpread_gap2_pdata, model = "within")
...
# EquSpreadRandom <- plm(EquSpendDelt ~ EUldrSpread_lag1 + CivilWar + Cab_liberty_authority + Cab_eu_anti_pro, data = EULeadershipSpread_gap2_pdata, model = "random")
