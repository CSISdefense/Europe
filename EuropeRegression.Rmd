...
EUDefSpreadResultsA <- plm(log(DefSpnd_lead) ~ DefSpread +  IntAt + log(Population) + log(GDPpCap), EuropeDefSpread, index=c("Country", "Year"), model="within") 
...
**Compare Fixed effects to random effects** Hausman test.
