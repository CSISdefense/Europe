...
EULeadershipResultsA <- plm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EULeadershipSpread, index=c("Country", "Year"), model="within") 
...
EULeadershipResults6 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr, EuropeDefSpread)

EULeadershipResults7 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop), EULeadershipSpread)

EULeadershipResults8 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC), EULeadershipSpread)

EULeadershipResults9 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EULeadershipSpread)

##edit government variable
EULeadershipResults10 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EULeadershipSpread)
...
EULeadershipResultsA <- plm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EULeadershipSpread, index=c("Country", "Year"), model="within") 
summary(DefSpreadresultsA)
...
NATOEssentialResults1 <- lm(log(Dspend_lead) ~ DefSpread, NATOEssentialSpread) 

NATOEssentialResults2 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt, NATOEssentialSpread)

NATOEssentialResults3 <- lm(log(Dspend_lead) ~ DefSpread + IntAt, NATOEssentialSpread)

NATOEssentialResults4 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt, NATOEssentialSpread)

NATOEssentialResults5 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivilWar, NATOEssentialSpread)

NATOEssentialResults6 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr, NATOEssentialSpread)

NATOEssentialResults7 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop), NATOEssentialSpread)

NATOEssentialResults8 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC), NATOEssentialSpread)

NATOEssentialResults9 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, NATOEssentialSpread)

##edit government variable
NATOEssentialResults10 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, NATOEssentialSpread)
...
NATOEssentialResultsA <- plm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, NATOEssentialSpread, index=c("Country", "Year"), model="within") 
summary(DefSpreadresultsA)
...
NATOEssentialResults6 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr, NATOEssentialSpread)

NATOEssentialResults7 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop), NATOEssentialSpread)

NATOEssentialResults8 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC), NATOEssentialSpread)

NATOEssentialResults9 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, NATOEssentialSpread)

##edit government variable
NATOEssentialResults10 <- lm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, NATOEssentialSpread)
...
NATOEssentialResultsA <- plm(log(EquSpnd_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, NATOEssentialSpread, index=c("Country", "Year"), model="within") 
summary(DefSpreadresultsA)
...
EUnNATOCloseSpreadResultsResults1 <- lm(log(Dspend_lead) ~ DefSpread, EUnNATOCloseSpread) 

EUnNATOCloseSpreadResultsResults2 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt, EUnNATOCloseSpread)

EUnNATOCloseSpreadResultsResults3 <- lm(log(Dspend_lead) ~ DefSpread + IntAt, EUnNATOCloseSpread)

EUnNATOCloseSpreadResults4 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt, EUnNATOCloseSpread)

EUnNATOCloseSpreadResults5 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivilWar, EUnNATOCloseSpread)

EUnNATOCloseSpreadResults6 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr, EUnNATOCloseSpread)

EUnNATOCloseSpreadResults7 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop), EUnNATOCloseSpread)

EUnNATOCloseSpreadResults8 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC), EUnNATOCloseSpread)

EUnNATOCloseSpreadResults9 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EUnNATOCloseSpread)

##edit government variable
EUnNATOCloseSpreadResults10 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EUnNATOCloseSpread)
...
EUnNATOCloseSpreadResultsA <- plm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EUnNATOCloseSpread, index=c("Country", "Year"), model="within") 
...
EUfvrSpreadResults1 <- lm(log(Dspend_lead) ~ DefSpread, EUfvrSpread) 

EUfvrSpreadResults2 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt, EUfvrSpread)

EUfvrSpreadResults3 <- lm(log(Dspend_lead) ~ DefSpread + IntAt, EUfvrSpread)

EUfvrSpreadResults4 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt, EUfvrSpread)

EUfvrSpreadResults5 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivilWar, EUfvrSpread)

EUfvrSpreadResults6 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr, EUfvrSpread)

EUfvrSpreadResults7 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop), EUfvrSpread)

EUfvrSpreadResults8 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC), EUfvrSpread)

EUfvrSpreadResults9 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EUfvrSpread)

##edit government variable
EUfvrSpreadResults10 <- lm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EUfvrSpread)
...
EUfvrSpreadResultsResultsA <- plm(log(Dspend_lead) ~ DefSpread + IntAt + DomAt + CivWr + IntWr + log(Pop) + log(GDPpC) + Dem, EUfvrSpreadResults, index=c("Country", "Year"), model="within") 
