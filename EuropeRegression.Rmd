...
EUDefSpreadResultsA <- plm(log(DefSpnd_lead) ~ DefSpread +  IntAt + log(Population) + log(GDPpCap), data=subset(EuropeDefSpread,Year>2004&Year<2013), index=c("Country", "Year"), model="within") 
summary(EUDefSpreadResultsA)

screenreg(list(EUDefSpreadResults9, EUDefSpreadResultsA))

#testing for two-ways effects
