...
EUantiProLine<-ggplot(data=EuropeSample,aes(x=Year),
               xlab="Year",
               ylab="Weighted Cabinet, Anti-EU=0 to Pro-EU=10")+
    geom_line(aes(y=Cab_eu_anti_pro),color="red")+
    geom_point(aes(y=Cab_eu_anti_pro),shape=16,color="red",size=5)+
    geom_line(aes(y=Opp_eu_anti_pro),color="blue")+
    geom_point(aes(y=Opp_eu_anti_pro),shape=2,color="blue",size=5)+
