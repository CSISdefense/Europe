...
EuropeLong$MetricValue[EuropeLong$MetricName %in% c("DefSpread")] <-EuropeLong$MetricValue[EuropeLong$MetricName %in% c("DefSpread")]/100
 EuropeLong$MetricValue[EuropeLong$MetricName %in% c("EUldrSpread")] <-EuropeLong$MetricValue[EuropeLong$MetricName %in% c("EUldrSpread")]/100
EuropeLong$MetricValue[EuropeLong$MetricName %in% c("NATOessSpread")] <-EuropeLong$MetricValue[EuropeLong$MetricName %in% c("NATOessSpread")]/100
EuropeLong$MetricValue[EuropeLong$MetricName %in% c("NATO.EUspread")] <-EuropeLong$MetricValue[EuropeLong$MetricName %in% c("NATO.EUspread")]/100
...
ScatterPlot(
    VAR.color.legend.label="",
    VAR.main.label="",
    VAR.X.label="Weighted Cabinet, Left to Right",
    VAR.Y.label="Overall Defense Spending, Annual Percent Change",
    Coloration,#VAR.Coloration
    VAR.base.row=1,
    VAR.base.col=1,
