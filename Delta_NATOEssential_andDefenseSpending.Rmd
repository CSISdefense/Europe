...
reg<-8
NATOessSpreadDef_model[reg] <- list(lm(DefSpendDelt_lead ~ NATOessSpread_lag2  + GDPpCapUSDdelt, EuropeNATOessSpread_gap3))
NATOessSpreadDef_name[reg]<-"GDPpCapUSDdelt"
screenreg(NATOessSpreadDef_model[c(3,reg)],
          custom.model.name=NATOessSpreadDef_name[c(3,reg)])
summary(NATOessSpreadDef_model[[reg]])
